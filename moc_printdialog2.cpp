...
QT_MOC_LITERAL(3, 36, 23) // "on_pushButton_2_clicked"
    ...
    "PrintDialog2\0on_pushButton_clicked\0\0"
...
void PrintDialog2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PrintDialog2 *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PrintDialog2::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_PrintDialog2.data,
    qt_meta_data_PrintDialog2,
    qt_static_metacall,
    nullptr,
    nullptr
} };
